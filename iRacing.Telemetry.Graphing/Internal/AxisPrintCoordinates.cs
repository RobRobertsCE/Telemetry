...
namespace iRacing.Telemetry.Graphing.Internal
{
    internal class AxisPrintCoordinates
    {
        ...
        public float maximumTickWidth;
        public float outermostTickX;
        public float smallTickX;
        public float largeTickX;
        public Size smallLabelSize = Size.Empty;
        public Size largeLabelSize = Size.Empty;
        ...
        public List<Tick> SmallTicks { get; set; } = new List<Tick>();
        public List<Tick> LargeTicks { get; set; } = new List<Tick>();
        public List<TickLabel> SmallLabels { get; set; } = new List<TickLabel>();
        public List<TickLabel> LargeLabels { get; set; } = new List<TickLabel>();
